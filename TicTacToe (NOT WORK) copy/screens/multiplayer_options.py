...
# ======== Multiplayer Options Class ======== #
class Multiplayer_Options_Class(MDN_Screen):
   # +----------------------------------------+
   # |                                        |
   # |               Init Class               |
   # |                                        |
   # +----------------------------------------+
    ...
    def create_body_ui(self):
        ...
        body_container_top_pading = MDN_GridLayout(mdn_app = self.mdn_app, mdn_cols = 1, mdn_size = ["80%", "80un"])
        ...
        default_options_container_rel_layout = MDN_RelativeLayout(mdn_size = ["100%", "260un"])
        ...
        more_options_container_rel_layout = MDN_RelativeLayout(mdn_size = ["100%", "390un"])
    ...
    def update_ui(self, *args):
        ...
        if self.mdn_app.mdn_screenmanager.current_screen.name != "multiplayer_options_screen":
            Clock.schedule_once(self.update_ui, 1)
            return
    ...
    def change_screen(self, *args):
        ...
        else: self.mdn_switch("multiplayer_game_screen", "Multiplayer")
